...
const CATEGORY_KEYWORDS = {
  ...
  technology: ["phone case", "usb charger", "smart watch", "keyboard", "mouse", "power bank", "webcam", "phone holder", "screen protector", "wireless charger", "usb hub", "laptop stand", "ring light", "tripod", "hdmi cable", "bluetooth adapter"],
